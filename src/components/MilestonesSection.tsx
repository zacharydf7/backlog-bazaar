      ...
      {open && (
        <div className="flex flex-col gap-1.5 pl-[21px]">
          ...
          <span className="text-[10px] text-subtle">
            Milestones are recorded automatically the first time each one happens, and Started and
            Beat again for each new run after a finish. Dates are yours to edit — backdate them to
            when it really happened, or add extra entries for anything missed. The Added date
            doubles as the game&apos;s acquisition date:

...
import { X, Library, Banknote, ImagePlus, Trash2, RotateCcw, Clock, Users, Gamepad2, ChevronDown, ChevronRight, Package, Lock, Search, LockOpen } from "lucide-react";
...
function PrerequisiteSection({ game }: { game: Game }) {
